...
class ActionExecutor:
    def __init__(
        ...
        # When provided, all join RPCs (ImportChatInviteRequest, JoinChannelRequest)
        # are routed to this secondary client so they don't compete with the main
        # update stream. Falls back to the main client when not set.
